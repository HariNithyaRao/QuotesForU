...
with col2:
    ...
    st.markdown("<h2><span style='text-align: center; color: violet;font-size: 70px; font-family:Rammetto One;'>Quotes</span> <span style='color: orange;font-family:Rammetto One, cursive;'>For</span> <span style='color: blue;font-family:Rammetto One, cursive;'>U</span></h2>", unsafe_allow_html=True)
colored_header(
    label="",
    description="",
