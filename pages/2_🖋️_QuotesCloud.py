...
txt1 = '<span style="color:midnightblue;font-size: 40px;font-family:Belgrano;">{}</span>'.format(rows[0])
txt2='<span style="color: darkslateblue;font-size: 40px;font-family:Belgrano;">{}</span>'.format(rows[1])
